...
Temp_SFH <- SFH|>
                select(3, 6, 7, 8, index_Jan2018 : ncol(SFH)) 
...
# Extract the data since Jan 2018 to the latest
Temp_Condo <- Condo|>
              select(3, 6, 7, 8, index_Jan2018_Condo : ncol(Condo)) 
...
Median_HP_CA <- Join_HP_CA|>
                 ...
                 group_by(Year) |>
                 summarize (Median_SFH_CA = median(SFH_Price, na.rm = TRUE),
                            Median_Condo_CA = median(Condo_Price, na.rm = TRUE))
